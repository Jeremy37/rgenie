...
The deletion analysis also has many more output tables. We encourage you to explore these outputs yourself, which are described in more detail in the **rgenie in depth** vignette.
...
You may also wish to consult the **rgenie in depth** vignette.
