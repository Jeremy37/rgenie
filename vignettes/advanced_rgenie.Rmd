...
```{r}
sprintf("Effect size for deletions within 20 bp: %f", del_results[[1]]$region_stats$del_window_effect)
sprintf("P value for deletions within 20 bp: %f", del_results[[1]]$region_stats$del_window_pval)
```
